...
class ElasticsearchBaseTestCase:
    ...
    def test_info_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(CommandExecutionError, elasticsearch_module.info)
    ...
    def test_cluster_health_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(CommandExecutionError, elasticsearch_module.cluster_health)
    ...
    def test_cluster_stats_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(CommandExecutionError, elasticsearch_module.cluster_stats)
    ...
    def test_alias_create_unack(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.alias_create("foo", "bar")
    ...
    def test_alias_create_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                ...
                elasticsearch_module.alias_create,
                "foo",
                "bar",
            )
    ...
    def test_alias_delete_unack(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.alias_delete("foo", "bar")
    ...
    def test_alias_exists_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.alias_exists("foo", "bar")
    ...
    def test_alias_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.alias_get("foo", "bar") is None
    ...
    def test_document_delete_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError,
                elasticsearch_module.document_delete,
                "foo",
                "bar",
                "baz",
            )
    ...
    def test_document_exists_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.document_exists("foo", "bar")
    ...
    def test_document_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.document_get("foo", "bar") is None
    ...
    def test_index_create_not_shards(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_create("foo", "bar")
    ...
    def test_index_delete_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_delete("foo", "bar")
    ...
    def test_index_exists_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_exists("foo", "bar")
    ...
    def test_index_get_settings_not_exists(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.index_get_settings(index="foo") is None
    ...
    def test_get_settings_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError, elasticsearch_module.index_get_settings, index="foo"
            )
    ...
    def test_index_put_settings_not_exists(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.index_put_settings(index="foo") is None
    ...
    def test_index_put_settings_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError,
                elasticsearch_module.index_put_settings,
                index="foo",
            )
    ...
    def test_index_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.index_get("foo", "bar") is None
    ...
    def test_index_open_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_open("foo", "bar")
    ...
    def test_index_close_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_close("foo", "bar")
    ...
    def test_mapping_create_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.mapping_create("foo", "bar", "baz")
    ...
    def test_mapping_create_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError, elasticsearch_module.mapping_create, "foo", "bar", "baz"
            )
    ...
    def test_mapping_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.mapping_get("foo", "bar", "baz") is None
    ...
    def test_mapping_get_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError, elasticsearch_module.mapping_get, "foo", "bar", "baz"
            )
    ...
    def test_index_template_create_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_template_create("foo", "bar")
    ...
    def test_index_template_create_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(
                CommandExecutionError, elasticsearch_module.index_template_create, "foo", "bar"
            )
    ...
    def test_index_template_delete_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_template_delete("foo")
    ...
    def test_index_template_exists_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.index_template_exists("foo")
    ...
    def test_index_template_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.index_template_get("foo") is None
    ...
    def test_pipeline_get_not(self):
        ...
        with patch.object(
            ...
            assert elasticsearch_module.pipeline_get("foo") is None
    ...
    def test_pipeline_get_failure(self):
        ...
        with patch.object(
            ...
            pytest.raises(CommandExecutionError, elasticsearch_module.pipeline_get, "foo")
    ...
    def test_pipeline_delete_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.pipeline_delete("foo")
    ...
    def test_pipeline_create_not(self):
        ...
        with patch.object(
            ...
            assert not elasticsearch_module.pipeline_create("foo", "bar")
