...
class MockElastic:
    ...
    def update(self, *args, **kwargs):
        ...
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"_id": "123", "_index": "test", "result": "updated"}
    ...
    def count(self, *args, **kwargs):
        """
        Mock of count method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"count": 42, "_shards": {"total": 1, "successful": 1, "failed": 0}}
    ...
    def mget(self, *args, **kwargs):
        ...
        return {
            "docs": [
                {"_id": "1", "_source": {"field": "value1"}, "found": True},
                {"_id": "2", "_source": {"field": "value2"}, "found": True},
            ]
        }
    ...
    def delete_by_query(self, *args, **kwargs):
        """
        Mock of delete_by_query method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"deleted": 10, "took": 100, "failures": []}

    @eswrapper
    def update_by_query(self, *args, **kwargs):
        """
        Mock of update_by_query method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"updated": 15, "took": 150, "failures": []}

    @eswrapper
    def reindex(self, *args, **kwargs):
        """
        Mock of reindex method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"took": 200, "created": 100, "updated": 0, "failures": []}

    @eswrapper
    def msearch(self, *args, **kwargs):
        """
        Mock of msearch method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {
    ...
    def open_point_in_time(self, *args, **kwargs):
        """
        Mock of open_point_in_time method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"id": "pit123"}
    ...
    def close_point_in_time(self, *args, **kwargs):
        """
        Mock of close_point_in_time method
        """
        if self.failure:
            raise TransportError("customer error", (123, 0))
        return {"succeeded": True, "num_freed": 1}
