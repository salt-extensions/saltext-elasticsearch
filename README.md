...
The saltext-elasticsearch project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-elasticsearch.git
...
* Writing blog posts
* Sharing your experiences using Salt + Elasticsearch
  on social media
